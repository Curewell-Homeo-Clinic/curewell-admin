...
const ClinicDeleteForm: React.FC<{ id: string }> = ({ id }) => {
  const router = useRouter();
  const trpcCtx = trpc.useContext();
  const mutation = trpc.useMutation(["clinic.delete"], {
    onSuccess() {
          ...
          <div className="relative bg-white rounded-lg shadow-lg">
            ...
            <div className="p-6 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-secondary">
                Are you sure you want to delete this clinic? It might have
                consequences.
              </h3>
              <button
...
export default ClinicDeleteForm;
