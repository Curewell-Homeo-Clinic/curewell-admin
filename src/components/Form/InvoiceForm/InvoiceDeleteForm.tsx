...
const InvoiceDeleteForm: React.FC<{
  ...
  const deleteMutation = trpc.useMutation("invoices.delete", {
    onSuccess() {
  ...
  const handleDelete = async () => {
    await deleteMutation.mutateAsync({
      ...
      products:
        invoice?.products.map((product) => ({ id: product.id })) || null,
    });
          ...
          <div className="relative bg-white rounded-lg shadow-lg">
            ...
            <div className="p-6 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-secondary">
                Are you sure you want to delete this invoice? It might have
                consequences, the data will be lost for forever.
              </h3>
              <button
